...
public class StyleConverterTest
{
    ...
    public void Convert_Style_GenericStyle_Xls_Returns_Style()
    {
        Style excelStyle = new()
        {
            ...
            DateTimeFormat = "yyyy/mm/dd hh:mm",
            FillForegroundColor = Color.Yellow,
            FillPattern = AwesomeExcel.Common.Models.FillPattern.LeastDots,
            FontStyle = null,
            HorizontalAlignment = AwesomeExcel.Common.Models.HorizontalAlignment.Distributed,
            VerticalAlignment = AwesomeExcel.Common.Models.VerticalAlignment.Top
        };
